...
public class AnimatedPieMenu extends PieMenu {
     ...
     */
    public AnimatedPieMenu(ShapeDrawer sd, PieMenuStyle style) {
        super(sd, style);
        this.style = getStyle();
    }
     ...
     */
    public AnimatedPieMenu(ShapeDrawer sd, Skin skin) {
        super(sd, skin);
        this.style = getStyle();
    }
     ...
     */
    public AnimatedPieMenu(ShapeDrawer sd, Skin skin, String style) {
        super(sd, skin, style);
        this.style = getStyle();
    }
